...
public class Songs extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.SongsRecord> {
	...
	private static final long serialVersionUID = 2031619785;
	 ...
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.SongsRecord, java.lang.String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "");

	/**
	 * The column <code>public.Songs.url</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.SongsRecord, java.lang.String> URL = createField("url", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "");
